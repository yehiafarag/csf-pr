...
//    private String accession, otherAccession;
    ...
    public ProteinsTableLayout(final Map<String, ProteinBean> proteinsList, final DatasetBean exp, final Map<Integer, DatasetBean> expList, final MainHandler expHandler) {//, final String accession,final String otherAccession) {
        this.setWidth("100%");
