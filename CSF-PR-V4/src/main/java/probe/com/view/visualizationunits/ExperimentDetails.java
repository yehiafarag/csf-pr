...
public class ExperimentDetails extends VerticalLayout implements Serializable, com.vaadin.event.LayoutEvents.LayoutClickListener {
    ...
    public ExperimentDetails(DatasetBean exp, boolean visability,MainHandler expHandler) {
    ...
    private VerticalLayout FormWithComplexLayout(DatasetBean exp,MainHandler expHandler) {
