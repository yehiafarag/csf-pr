...
import probe.com.view.visualizationunits.ProteinsTable;
import probe.com.view.visualizationunits.SearchResultsTable;
...
public class CustomExportBtnLayout extends VerticalLayout implements Serializable, Button.ClickListener {
     ...
     * 
     */
    public CustomExportBtnLayout(MainHandler handler, String type, int expId, String expName, String accession, String otherAccession, Map<Integer, DatasetBean> expList, Map<String, ProteinBean> proteinsList, int fractionNumber, Map<Integer, PeptideBean> peptidesList, Table fractionTable, Map<Integer, ProteinBean> fullExpProtList) {
