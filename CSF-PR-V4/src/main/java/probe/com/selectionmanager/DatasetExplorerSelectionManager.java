...
//        this.filteredDatasetsList = QuantDatasetObject[];
//        datasetMap = new QuantDatasetObject[datasetsList.size()];
...
//    public void updatedSelectionUpdate(CSFFilterSelection selection) {
//        try { VaadinSession.getCurrent().getLockInstance().lock();
//           if(selection.getType().equalsIgnoreCase("comparisonfilter")){
//                for(int x:selection.getDatasetIndexes())
//                System.out.println("at selection manager --- update the dss ( "+x+" )");       
//            
//            }
//            this.SelectionChanged(selection.getType());
//        } finally {
