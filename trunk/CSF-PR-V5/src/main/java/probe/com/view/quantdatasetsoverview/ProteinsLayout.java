 ...
 * @author Yehia Farag
 */
public class ProteinsLayout extends VerticalLayout implements CSFFilter, TabSheet.SelectedTabChangeListener {
    ...
    private boolean removingAllTabs = false;
    ...
    public void selectionChanged(String type) {
        if (type.equalsIgnoreCase("quantProtSelection" )&& !selfSelection) {          
            ...
            for (final String key : protSelectionMap.keySet()) {
                ...
                final Tab t1 = proteinsTabsheet.addTab(vlo);
...
//        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    ...
    public ProteinsLayout(final DatasetExploringSelectionManagerRes selectionManager) {
        this.selectionManager = selectionManager;
        this.selectionManager.registerFilter(ProteinsLayout.this);
        this.setHeight("100%");
        ...
        proteinsTabsheet.addSelectedTabChangeListener(ProteinsLayout.this);
...
//        ProtOverviewLineChart overallPlotLayout = new ProtOverviewLineChart(comparisonProteins,(width-200));
        ProtOverviewCharts overallPlotLayout = new ProtOverviewCharts(selectionManager,comparisonProteins, selectedComparisonList, (width ));
...
//        bodyLayout.setExpandRatio(overallPlotLayout, 0.3f);

//        bodyLayout.setExpandRatio(tabLayout, 0.6f);
        return bodyLayout;
    ...
    public void redrawCharts(){
     ...
     ProtOverviewCharts overallPlotLayout = (ProtOverviewCharts) selectedTab.getComponent(1); 
