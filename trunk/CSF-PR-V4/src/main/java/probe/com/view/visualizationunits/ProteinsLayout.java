...
public final class ProteinsLayout extends VerticalLayout implements Serializable, Property.ValueChangeListener {
    ...
    public ProteinsLayout(MainHandler handler) {
        ...
        this.datasetIndex = handler.getDatasetIndex();
        this.setWidth("100%");
        this.setHeight("100%");this.removeAllComponents();
...
//            lowerLayout.setExpandRatio(helpIco, 0.4f);
    ...
    public void valueChange(Property.ValueChangeEvent event) {
        ...
        if (o != null && (!o.toString().equals(s))) {
            ...
            key = util.getKey(datasetNamesList, str,datasetIndex);
            exp = datasetList.get(key);
            ...
            if (exp != null && exp.getExpType() == 1) {
                ...
                if (exp.getReady() != 2 && exp.getFractionsNumber() > 0 || exp.getProteinsNumber() == 0) {
                    ...
                    proteinsList = expHandler.getProteinsList(exp.getExpId(), datasetList);
                    ...
                    protTableLayout = new ProteinsTableLayout(proteinsList, exp, datasetList, expHandler);
                    ...
                    ValueChangeListener listener = new Property.ValueChangeListener() {
                        ...
                        public synchronized void valueChange(Property.ValueChangeEvent event) {
                            ...
                            CustomExportBtnLayout ce1 = new CustomExportBtnLayout(expHandler, "allProtPep", exp.getExpId(), exp.getName(), accession, otherAccession, datasetList, null, 0, null, null, null);
                            CustomExportBtnLayout ce2 = (new CustomExportBtnLayout(expHandler, "prots", exp.getExpId(), exp.getName(), accession, otherAccession, datasetList, proteinsList, exp.getFractionsNumber(), null, null, null));
                           ...
                           //   HorizontalLayout p2 = help.getExpIcon(ce2,"Export CSF-PR Proteins for ( "+ exp.getName()+" )","Export CSF-PR Proteins for ( "+ exp.getName()+" )" );
                            ...
                            if (key < 0) {
                                ...
                                exp = datasetList.get(exp.getExpId());
                                ...
                                if (pepProtList.isEmpty()) {
                                    ...
                                    CustomExportBtnLayout ce3 = new CustomExportBtnLayout(expHandler, "protPep", exp.getExpId(), exp.getName(), accession, otherAccession, datasetList, null, 0, pepProtList, null, null);
                                ...
                                fractionsList = expHandler.getFractionsList(exp.getExpId(), datasetList);
...
//                                        Notification.show("YOU NEED TO SELECT A READY DATASET FIRST!");
    ...
    public Map<Integer, DatasetBean> getExpList() {
        return datasetList;
    }

    public void setExpList(Map<Integer, DatasetBean> expList) {
        this.datasetList = expList;
    }

    private ExperimentDetails buildExpView(DatasetBean exp, boolean visability2) {
